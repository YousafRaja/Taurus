...
static double ENCODER_RESOLUTION = 1;// 250*4;
double wheel_circumference = 12.666;
double wheel_base_length = 5.666;
double wheel_diameter = 4.666;
double encoder_poll_rate;
std::string odom_frame_id;
size_t error_count;
double target_speed = 666.666;
double target_direction = 1.0;
...
int main(int argc, char **argv) {
	...
	ROS_INFO ("test2");
        ...
        ROS_INFO("TEST2AX2550 connecting to port %s", port.c_str());
        try {
            mc = new AX2550();
